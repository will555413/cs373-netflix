...
def netflix_solve (r, w) :
    ...
    if os.path.isfile('/u/ebanner/netflix-tests/wc6892-ucacheoff.txt') and os.path.isfile('/u/ebanner/netflix-tests/wc6892-mcacheoff.txt') and os.path.isfile('/u/downing/netflix/probe.txt') and os.path.isfile('/u/ebanner/netflix-tests/cls3282-probe_actual.txt'):
        ...
        ufile = StringIO(get('http://www.cs.utexas.edu/users/ebanner/netflix-tests/wc6892-ucacheoff.txt').text)
        mfile = StringIO(get('http://www.cs.utexas.edu/users/ebanner/netflix-tests/wc6892-mcacheoff.txt').text)
        probe = StringIO(get('http://www.cs.utexas.edu/users/downing/netflix/probe.txt').text)
        probe_actual = StringIO(get('http://www.cs.utexas.edu/users/ebanner/netflix-tests/cls3282-probe_actual.txt').text)
