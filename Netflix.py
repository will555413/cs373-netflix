...
def netflix_solve (r, w) :
    ...
    probe = 0
    probe_actual = 0
    # if os.path.isfile('/u/ebanner/netflix-tests/wc6892-ucacheoff.txt') and os.path.isfile('/u/ebanner/netflix-tests/wc6892-mcacheoff.txt') and os.path.isfile('/u/downing/netflix/probe.txt','r') and os.path.isfile('/u/ebanner/netflix-tests/cls3282-probe_actual.txt','r'):
    #     # Read cache from the file /u/ebanner/netflix-tests/path/to/caches
    #     ufile = open('/u/ebanner/netflix-tests/wc6892-ucacheoff.txt','r')
    #     mfile = open('/u/ebanner/netflix-tests/wc6892-mcacheoff.txt','r')
    #     probe = open('/u/downing/netflix/probe.txt','r')
    #     probe_actual = open('/u/ebanner/netflix-tests/cls3282-probe_actual.txt','r')
    # else:
    ...
    #     probe = requests.get('http://www.cs.utexas.edu/users/downing/netflix/probe.txt')
    #     probe_actual = requests.get('http://www.cs.utexas.edu/users/ebanner/netflix-tests/cls3282-probe_actual.txt')

    ufile = StringIO(requests.get('http://www.cs.utexas.edu/users/ebanner/netflix-tests/wc6892-ucacheoff.txt'))
    mfile = StringIO(requests.get('http://www.cs.utexas.edu/users/ebanner/netflix-tests/wc6892-mcacheoff.txt'))
    probe = StringIO(requests.get('http://www.cs.utexas.edu/users/downing/netflix/probe.txt'))
    probe_actual = StringIO(requests.get('http://www.cs.utexas.edu/users/ebanner/netflix-tests/cls3282-probe_actual.txt'))
    ...
    # actual = probe_read(probe, probe_actual, actual)
